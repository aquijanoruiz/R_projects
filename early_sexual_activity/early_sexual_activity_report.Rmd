...
**Table 1: Percentage and mean levels of explanatory variables by early sexual activity**
...
stargazer(summary_statistics_copy, type = "latex", title="Logistic Regression Results", align=TRUE)
```
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, out.width='80%', fig.align='center', out.height='70%'}
...
stargazer(logit_m1, logit_m2, title="Logistic Regression Results", align=TRUE)
