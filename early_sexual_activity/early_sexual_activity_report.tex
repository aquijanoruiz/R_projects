...
\toprule
  & Total & \makecell[c]{Early\\sexual initiatiors} & \makecell[c]{Non-early\\sexual initiatiors} & p value\\
\midrule
\addlinespace[2em]
\multicolumn{5}{l}{\textit{Explanatory variables}}\\
\hspace{1em}Mother lacks sexual empowerment & 0.08 & 0.11 & 0.07 & 0.137\\
\hspace{1em}Mother had a teenage birth & 0.53 & 0.69 & 0.49 & 0.000 ***\\
\hspace{1em}Mother's age at first intercourse & 17.38 & 16.11 & 17.64 & 0.000 ***\\
\addlinespace[2em]
\multicolumn{5}{l}{\textit{Mother-related variables}}\\
\hspace{1em}Mother has a job & 0.60 & 0.68 & 0.59 & 0.041 **\\
\hspace{1em}Mother finished primary school & 0.97 & 0.94 & 0.98 & 0.016 **\\
\hspace{1em}Mother finished high school & 0.54 & 0.50 & 0.55 & 0.291\\
\hspace{1em}Mother finished college & 0.16 & 0.11 & 0.17 & 0.124\\
\addlinespace[2em]
\multicolumn{5}{l}{\textit{Daughter-related variables}}\\
\hspace{1em}Misses school & 0.08 & 0.26 & 0.04 & 0.000 ***\\
\hspace{1em}Lacked knowledge about period & 0.20 & 0.28 & 0.18 & 0.009 ***\\
\hspace{1em}Knows about sexuality from family & 0.12 & 0.15 & 0.11 & 0.253\\
\hspace{1em}Knows about sexuality from school & 0.80 & 0.74 & 0.81 & 0.071  *\\
...
\hspace{1em}Mother has a job & 0.60 & 0.51 & 0.61 & 0.099 * & 0.62 & 0.59 & 0.418 & 17.36\\
\hspace{1em}Mother finished primary school & 0.97 & 0.97 & 0.97 & 1 & 0.98 & 0.97 & 0.502 & 17.42\\
\hspace{1em}Mother finished high school & 0.54 & 0.44 & 0.55 & 0.093 * & 0.48 & 0.61 & 0.000 *** & 17.97\\
\hspace{1em}Mother finished college & 0.16 & 0.08 & 0.16 & 0.094 * & 0.12 & 0.20 & 0.000 *** & 18.89\\
\addlinespace[2em]
\multicolumn{9}{l}{\textit{Daughter-related variables}}\\
\hspace{1em}Misses school & 0.08 & 0.07 & 0.08 & 0.895 & 0.09 & 0.07 & 0.213 & 15.97\\
\hspace{1em}Lacked knowledge about period & 0.20 & 0.25 & 0.19 & 0.349 & 0.21 & 0.18 & 0.199 & 16.93\\
\hspace{1em}Knows about sexuality from family & 0.12 & 0.07 & 0.12 & 0.266 & 0.14 & 0.09 & 0.015 ** & 17.20\\
...
\begin{table}[!htbp] \centering    \caption{Logistic Regression Results}    \label{}  \begin{tabular}{@{\extracolsep{5pt}}lD{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} }  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{3}{c}{\textit{Dependent variable:}} \\  \cline{2-4}  \\[-1.8ex] & \multicolumn{3}{c}{Early sexual initiation} \\  \\[-1.8ex] & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)}\\  \hline \\[-1.8ex]   Mother lacks sexual empowerment & 0.543^{*} & 0.499 & 0.476 \\    & (0.323) & (0.327) & (0.329) \\    Mother had a teenage birth &  & 0.712^{***} & 0.329 \\    &  & (0.207) & (0.234) \\    Mother's age at first intercourse &  &  & -0.160^{***} \\    &  &  & (0.050) \\   &  &  &  \\   &  &  &  \\    Mother has a job & 0.583^{***} & 0.555^{***} & 0.544^{**} \\    & (0.212) & (0.214) & (0.215) \\    Mother finished primary school & -0.594 & -0.676 & -0.652 \\    & (0.495) & (0.506) & (0.503) \\    Mother finished high school & -0.352 & -0.386 & -0.303 \\    & (0.511) & (0.523) & (0.520) \\    Mother finished college & -0.450 & -0.420 & -0.231 \\    & (0.578) & (0.587) & (0.588) \\   &  &  &  \\  &  &  &  \\    Misses school & 2.113^{***} & 2.123^{***} & 2.031^{***} \\    & (0.297) & (0.300) & (0.305) \\    Lacked knowledge about period & 0.333 & 0.314 & 0.324 \\    & (0.233) & (0.235) & (0.238) \\    Knows about sexuality from family & 1.808^{***} & 1.612^{***} & 1.576^{***} \\    & (0.592) & (0.605) & (0.607) \\    Knows about sexuality from school & 1.331^{**} & 1.234^{**} & 1.202^{**} \\    & (0.535) & (0.546) & (0.548) \\    Knows about sexuality from other sources & 2.199^{***} & 2.010^{***} & 1.989^{***} \\    & (0.676) & (0.688) & (0.690) \\   \hline \\[-1.8ex]  Household-related controls? & Yes & Yes & Yes \\  Observations & \multicolumn{1}{c}{920} & \multicolumn{1}{c}{920} & \multicolumn{1}{c}{920} \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{3}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}  \end{table}
