...
kable(table_sum_stat_copy, format = "latex", booktabs = T, linesep = "", escape = F,
  ...
  footnote(general = "p values for comparison of percentages using chi-square. p values for comparison of means using t-test. Ns = 401–828. *p < .1; **p < .05; ***p < .01",
